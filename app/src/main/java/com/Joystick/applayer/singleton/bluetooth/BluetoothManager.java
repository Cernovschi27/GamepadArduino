package com.Joystick.applayer.singleton.bluetooth;
...
import com.Joystick.applayer.singleton.bluetooth.event.BluetoothConnectedEvent;
import com.Joystick.applayer.singleton.bluetooth.event.BluetoothConnectionFailedEvent;
import com.Joystick.applayer.singleton.bluetooth.event.BluetoothDataReceivedEvent;
import com.Joystick.applayer.singleton.bluetooth.event.BluetoothDisconnectedEvent;

import app.applayer.bluetotohspp.library.BluetoothSPP;
import app.applayer.bluetotohspp.library.BluetoothState;
import app.applayer.bluetotohspp.library.DeviceList;
